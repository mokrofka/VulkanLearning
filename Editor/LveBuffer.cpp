...
LveBuffer::LveBuffer(LveDevice&            device,
	...
	lveDevice{device}, instanceSize{instanceSize}, instanceCount{instanceCount},
 ...
 *
 */
void LveBuffer::writeToIndex(void* data, i32 index) {
 ...
 *
 */
VkResult LveBuffer::flushIndex(i32 index) { return flush(alignmentSize, index * alignmentSize); }
 ...
 */
VkDescriptorBufferInfo LveBuffer::descriptorInfoForIndex(i32 index) {
 ...
 * @return VkResult of the invalidate call
 */
VkResult LveBuffer::invalidateIndex(i32 index) {
