...
b8 LveDevice::isDeviceSuitable(VkPhysicalDevice device) {
...
b8 LveDevice::checkValidationLayerSupport() {
	u32 layerCount;
...
b8 LveDevice::checkDeviceExtensionSupport(VkPhysicalDevice device) {
	u32 extensionCount;
...
u32 LveDevice::findMemoryType(u32 typeFilter, VkMemoryPropertyFlags properties) {
